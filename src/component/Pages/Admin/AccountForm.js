...
const AccountForm = () => {
  ...
  const [register, setRegister] = useState({gender: 'M', role: '1', birth_date: '2/10/2023'})
  ...
  const submitHandler = (e) => {
    ...
    axios.post(`${serverURL()}/users/createUser`,register,{headers: {"Content-Type": "application/json"}})
  }
    ...
    <>
      <div className="p-4 sm:ml-64">
        ...
        <div className="p-4 rounded-lg mt-14 border-2 border-gray-200 shadow-sm">
          ...
          <AccountTable submitted={submitted} stateHandler={stateHandler} />
        </div>
      </div>
    </>
  );
